...
async def start(client, message):
        await bot.join_chat("KINGBOTOFFICIALCHAT", "KINGBOTOFFICIAL", "about_kartikrajofficial")
...
print("Your Chatbot Is Ready Now! Join @KINGBOTOFFICIAL And @KINGBOTOFFICIALCHAT")
bot.run()
